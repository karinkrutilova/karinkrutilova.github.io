...
assert.match(globalStyles, /\.wordmark-icon\s*\{[^}]*width:\s*14px[^}]*stroke:\s*currentColor/s);
...
assert.match(globalStyles, /\.works::after\s*\{[^}]*opacity:\s*\.57[^}]*background-image:\s*url\('\/gallery-smoke\.webp'\)/s);
